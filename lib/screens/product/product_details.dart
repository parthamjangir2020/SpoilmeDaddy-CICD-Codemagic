...
class _ProductDetailsState extends State<ProductDetails>
  ...
  // MODIFIED: This method now checks the stock and displays the appropriate buttons.
  Widget buildBottomAppBar(BuildContext context, addedToCartSnackbar) {
    // Check if product details are fetched and if the stock is 0 or less.
    if (_productDetails != null && _stock != null && _stock! <= 0) {
      // If out of stock, show a single, disabled gray button.
      return BottomAppBar(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(6.0),
            color: Colors.grey, // A distinct gray color for the disabled state
          ),
          child: Center(
            child: Text(
              "Out of Stock", // Using a hardcoded string, but AppLocalizations is better.
              // AppLocalizations.of(context)!.out_of_stock_ucf,
              style: TextStyle(
                color: Colors.white,
                fontSize: 16,
                fontWeight: FontWeight.w600,
    ...
    // If in stock, show the "Add to Cart" and "Buy Now" buttons.

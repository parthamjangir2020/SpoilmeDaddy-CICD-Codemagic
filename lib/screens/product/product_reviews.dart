...
//     );
//
//     // Check if the reviews list from the response is not null before adding
//     if (reviewResponse.reviews != null) {
//       _reviewList.addAll(reviewResponse.reviews!);
//     }
//     _isInitial = false;
//     // Also, a good practice to check meta before accessing its properties
//     if (reviewResponse.meta != null) {
//       _totalData = reviewResponse.meta!.total;
//     }
//
//     _showLoadingContainer = false;
...
//                   itemSize: 12.0,
//                   ignoreGestures: true,
//                   initialRating: _reviewList[index].rating.toDouble(),
//                   direction: Axis.horizontal,
//                   allowHalfRating: false,
//                   itemCount: 5,
//                   ratingWidget: RatingWidget(
